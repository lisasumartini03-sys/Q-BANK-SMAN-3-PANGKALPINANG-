...
# ---------------------------------------------------------
# 3. ANALISIS KUANTITATIF (EMPIRIS - DENGAN KEPUTUSAN DISTRAKTOR)
# ---------------------------------------------------------
    ...
    if uploaded_file is not None:
        ...
        if df_raw is not None:
            ...
            try:
                ...
                # --- FITUR TERBARU: EFEKTIVITAS PENGECOH + KEPUTUSAN TEORI ---
                st.subheader("🎯 Efektivitas Pengecoh (Distraktor ABCDE)")
                st.caption("💡 *Teori Evaluasi:* Pengecoh berfungsi baik jika dipilih **≥ 5% siswa** dan lebih banyak dipilih oleh **Kelompok Bawah**.")
                ...
                for idx, col in enumerate(soal_cols):
                    ...
                    # Status Berdasarkan Pengecoh (Opsional selain kunci)
                    dist_status = []
