...
if menu == "🏠 Beranda":
    ...
    with col1:
        st.markdown("""
            <div class='card-info'>
                ...
                <p>Fitur penelaahan instrumen soal dengan pilihan mata pelajaran & metadata lengkap.</p>
                <ul>
                    <li>Pilihan Dropdown Mata Pelajaran & Kelompok Mapel</li>
                    <li>Input Fase/Kelas, Indikator, & Level Kognitif</li>
    ...
    st.write("""
    1. Buka menu **Analisis Kualitatif**, pilih Mata Pelajaran dari daftar pilihan, tentukan Fase/Kelas, dan isi nama Validator.
...
# ---------------------------------------------------------
    ...
    st.write("Silakan pilih mata pelajaran, fase/kelas, validator, dan detail butir soal.")
    ...
    with st.expander("📌 **A. Identitas Mata Pelajaran & Kelas**", expanded=True):
        ...
        with col_m1:
            ...
            # Pilihan Dropdown Mata Pelajaran
            daftar_mapel = [
                "Biologi", "Fisika", "Kimia", "Matematika Tingkat Lanjut",
                "Matematika Umum", "Ekonomi", "Geografi", "Sosiologi", "Sejarah",
                "Bahasa Indonesia", "Bahasa Inggris", "Bahasa Inggris Tingkat Lanjut",
                "Pendidikan Pancasila / PKn", "Pendidikan Agama & Budi Pekerti",
                "PJOK", "Seni Budaya / Seni Rupa", "Informatika", "Prakarya & Kewirausahaan (PKWU)",
                "Lainnya (Ketik Manual)"
            ]
            mapel_pilihan = st.selectbox("Nama Mata Pelajaran:", daftar_mapel)
            
            if mapel_pilihan == "Lainnya (Ketik Manual)":
                nama_mapel = st.text_input("Ketik Nama Mata Pelajaran:", value="")
            else:
                nama_mapel = mapel_pilihan
