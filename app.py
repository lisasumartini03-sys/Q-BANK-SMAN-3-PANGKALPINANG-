...
# FUNGSI DETEKSI LOGO SMANETA (Mendukung file logo transparan & variasi lainnya)
def get_logo_path():
    possible_names = [
        "66b480c34cb96SMAN_3_PANGKALPINANG-removebg-preview (1).png",
        "images (9).jfif", "images (9).png", "images (9).jpg", "images (9).jpeg",
        "images (8).png", "images (8).jpg"
    ]
...
# Deteksi logo untuk Favicon browser
logo_favicon = get_logo_path() if get_logo_path() else "https://upload.wikimedia.org/wikipedia/commons/2/23/Logo_SMA_Negeri_3_Pangkalpinang.png"
...
if not st.session_state.logged_in:
    ...
    with col2:
        ...
        if logo_path:
            ...
            st.image("https://upload.wikimedia.org/wikipedia/commons/2/23/Logo_SMA_Negeri_3_Pangkalpinang.png", width=200)
...
if logo_path:
    ...
    st.sidebar.image("https://upload.wikimedia.org/wikipedia/commons/2/23/Logo_SMA_Negeri_3_Pangkalpinang.png", width=110)
